...
class MLATokenToKVPoolTQ(MLATokenToKVPool):
    ...
    def _create_buffers(self):
        ...
        from sglang.srt.layers.quantization.turboquant_engine import (
            get_codebook, packed_bytes_per_dim, generate_rotation_matrix,
        )
        ...
        self.tq_bit_width = int(self.tq_effective_bits)  # integer part for uniform mode
        self.tq_mixed = self.tq_effective_bits != int(self.tq_effective_bits)  # 2.5, 3.5
        ...
        with self.memory_saver_adapter.region(GPU_MEMORY_TYPE_KV_CACHE):
            with (
                ...
                norms_bytes = self.tq_n_groups * 2
        ...
        logger.info(
            f"TurboQuant MLA KV Pool: {bits_str}{qjl_str}, "
